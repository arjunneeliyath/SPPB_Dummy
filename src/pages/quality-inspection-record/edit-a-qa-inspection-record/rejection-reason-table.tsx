...
const RejectionReasonTable = (props: IRejectionReasonProps) => {
    ...
    const addRows = () => {
        ...
        const categories: IParameterValues[] = doneWithSelection.formFields.defectCategories;
    ...
    const handleRowSelectChange = (event: React.ChangeEvent<any>, name: string, index: number) => {
        ...
        if (name === 'categoryList') {
            const defects = doneWithSelection.formFields.defects.filter((data) => data.defectCatId === Number(id));
